...
function Banner() {
    ...
    return (
        <section className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-12 md:mx-10 '>
            {/* ####### Left side ##### */}
            <div className='flex-1 py-8 sm:py-10 md:py-16 lg:p-24 lg:pl-5'>
